...
/// Opaque handle that owns telemetry state for one progress-reporting stream.
///
...
/// Snapshot of a progress update delivered to sink callbacks.
///
...
/// Callback bundle used to receive progress and log output.
///
